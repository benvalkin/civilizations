...
public enum BuildingTypeOld {
   ...
   public boolean isArtisanBuilding() {
      return switch (this) {
      case BAKER_HOUSE, BUTCHER_HOUSE, LEATHERWORKER_HOUSE, WEAVER_HOUSE, BLACKSMITH_HOUSE, TOOLSMITH_HOUSE,
            WEAPONSMITH_HOUSE, ARMORER_HOUSE, CARPENTER_HOUSE, MASON_HOUSE, ARTIST_HOUSE, CARTOGRAPHER_HOUSE ->
         true;
      default -> false;
      };
   }
