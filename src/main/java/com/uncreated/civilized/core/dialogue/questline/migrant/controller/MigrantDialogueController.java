...
import com.uncreated.civilized.core.dialogue.questline.migrant.MigrantFarmerQuest1;
import com.uncreated.civilized.core.dialogue.questline.migrant.MigrantWoodcutterQuest1;
...
public class MigrantDialogueController extends DialogueController {
   ...
   private static final SimpleWeightedRandomList<DialogueFlow> FLOW_OPTIONS =
         new SimpleWeightedRandomList.Builder<DialogueFlow>().add(new MigrantFarmerQuest1(), 20)
               .add(new MigrantWoodcutterQuest1(), 20)
               .build();
