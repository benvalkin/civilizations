...
public class OffloadImportedResourcesAtHome extends ExchangeResourcesAtBuilding {

   public OffloadImportedResourcesAtHome() {
      super(
            ImmutableMap.of(
   ...
   protected void exchangeResources(ServerLevel level, CivilizedVillager villager, long tickTime) {
      ...
      villager.getBrain().eraseMemory(AIRegistry.MM_HOLDING_IMPORT_RESOURCES.get());
   }
}
