...
public class CraftingProductionTabButton extends BuildingTabButton {
   ...
   public CraftingProductionTabButton(AScreenWithTabs menuScreenWithTabs, int buttonTabIndex) {
      super(menuScreenWithTabs, buttonTabIndex, ICON, Tooltip.create(ProductionType.CRAFTING.getHeading()));
   }
}
