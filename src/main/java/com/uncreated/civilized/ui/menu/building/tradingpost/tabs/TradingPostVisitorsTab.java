...
public class TradingPostVisitorsTab extends ABuildingScreenTab {

   private List<VillagerInfo> visitors;

   public TradingPostVisitorsTab(
         int index,
         int x,
         int y,
         int width,
   ...
   public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
      ...
      if (visitors.isEmpty()) {
         graphics.drawWordWrap(
               font,
               Component.translatable("menu.building.trading_post.visitors.count.heading.empty"),
               getX(),
               getY() + 20,
               width,
      ...
      graphics.drawString(
            font,
            Component.translatable("menu.building.trading_post.visitors.count.heading"),
            getX(),
            getY() + 20,
            Colors.MENU_TEXT_DARK,
            false);
