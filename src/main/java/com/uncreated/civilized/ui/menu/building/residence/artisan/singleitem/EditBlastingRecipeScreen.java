...
public class EditBlastingRecipeScreen extends EditRecipeScreen<EditBlastingRecipeMenu> {
   ...
   public EditBlastingRecipeScreen(EditBlastingRecipeMenu menu, Inventory playerInventory, Component title) {
