...
public class EditCraftingMenuScreen extends EditRecipeScreen<EditCraftingRecipeMenu> {
   ...
   public EditCraftingMenuScreen(EditCraftingRecipeMenu menu, Inventory playerInventory, Component title) {
