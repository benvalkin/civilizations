...
import com.uncreated.civilized.ui.components.buttons.buildingtab.production.SmokingProductionTabButton;
...
public class ButcheryBuildingScreen extends ABuildingScreen {

   public ButcheryBuildingScreen(BuildingScreenContext context, Component title) {
      super(context, title);
   }
   ...
   public List<Button> createTabButtons() {
      return List.of(
            ...
            new SmokingProductionTabButton(this, 2),
