...
public class GroveBuildingScreen extends WorksiteBuildingScreen {
   ...
   public GroveBuildingScreen(Building building, Settlement settlement, Component title) {
   ...
   protected List<ATab> createTabs(int contentLeftPos, int contentTopPos, int tabWidth, int tabHeight) {
      ...
      return List.of(
            new GroveInfoTab(0, contentLeftPos, contentTopPos, tabWidth, tabHeight, this.font, building, settlement),
